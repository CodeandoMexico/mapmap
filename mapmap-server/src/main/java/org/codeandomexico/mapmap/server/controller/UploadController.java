...
public class UploadController {
    ...
    public UploadController(MainService mainService, UploadService uploadService) {
        this.mainService = mainService;
        this.uploadService = uploadService;
    }

    @PostMapping("/upload")
    public void uploadRoutes(@RequestParam(name = "imei") String imei, @RequestParam(name = "data") MultipartFile data, HttpServletResponse response) throws IOException {
