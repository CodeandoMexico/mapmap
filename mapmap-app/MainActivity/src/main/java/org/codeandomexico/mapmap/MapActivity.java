...
public class MapActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txt1 = findViewById(R.id.descriptionText);
        Typeface font1 = Typeface.createFromAsset(getAssets(), "fonts/bebasneue_bold.ttf");
        txt1.setTypeface(font1);

        TextView txt2 = findViewById(R.id.notesText);
        ...
        if (rc != null) {
            ...
            for (RouteStop s : rc.stops) {
                ...
                OverlayItem itemMarker = new OverlayItem("Subio: " + s.board + " Bajo: " + s.alight, "", new GeoPoint(s.location.getLatitude(), s.location.getLongitude()));
